...
if __name__ == '__main__':
    ...
    pygame.init()  # inialize all pygame modules
    FPSCLOCK = pygame.time.Clock()
    pygame.display.set_caption('Flappy Bird by Efan')

    # Game Sprites

    GAME_SPRITES['numbers'] = (
        pygame.image.load('gallery/sprites/0.png').convert_alpha(),  # faster bliting use,optimized image
    ...
    while True:
        welcomeScreen()  # Shows welcome screen until user presses button
        print('end')
